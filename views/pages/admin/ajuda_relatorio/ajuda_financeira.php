...
$ajuda = $controller->listarAjudaFinanceira();  
?>
...
<body>
    ...
    <section>
        <div class="titulo">
            <h1>Pedido de Ajuda: Violência Financeira</h1>
            <button onclick="window.open('../../../../gerarPDF/gerarPDFFinan.php')">Gerar PDF</button>
        </div>
        <div class="table">
            <table id="table">
                <thead>
                ...
                <tbody>
                    <?php foreach ($ajuda as $row): ?>
                        <tr>
                            ...
                            <td><button onclick="abrirModalFinanceira(<?php echo $row['id_violencia']; ?>)">Ver Detalhes</button></td>
                        </tr>
                    <?php endforeach; ?>
                </tbody>
            </table>
        ...
        <div id="modalFinanceira" class="modal">
            <div class="modal-content">
                ...
                <p id="nomeUser"></p>
                <h3>Você tem controle sobre o seu próprio dinheiro ou salário?</h3>
                <p id="controle"></p>
                <h3>Alguém impede você de trabalhar ou tomar decisões financeiras?</h3>
                <p id="impedido"></p>
                <h3>Você tem acesso a recursos financeiros básicos (dinheiro, cartão, contas)?</h3>
                <p id="acesso"></p>
                <h3>Quem controla suas finanças?</h3>
                <p id="controlador"></p>
                <h3>Você já se sentiu obrigado(a) a entregar seu dinheiro para alguém?</h3>
                <p id="coagido"></p>
                <h3>Você já procurou ajuda ou orientação financeira?</h3>
    ...
    <script src="../../../js/ajuda_financeira.js"></script>
