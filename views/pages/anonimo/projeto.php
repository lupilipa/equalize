...
<body>
    ...
    <main>
        ...
        Justificativa
        A violência de gênero é uma problemática persistente, enraizada em muitas sociedades, incluindo o Brasil, e afeta significativamente o ambiente escolar. Esse tipo de violência se manifesta através de agressões físicas, verbais, assédio e discriminação, impactando negativamente o desenvolvimento emocional, psicológico e acadêmico das vítimas. O projeto Equalize surgiu da necessidade urgente de uma ferramenta eficaz para lidar com a violência de gênero nas escolas, oferecendo conscientização e suporte de maneira prática e acessível. A plataforma visa criar um ambiente seguro e acolhedor para todos, permitindo que vítimas relatem incidentes de forma anônima, incentivando a busca por ajuda sem medo de represálias ou estigmatização. Além disso, o Equalize educa a comunidade escolar, incluindo alunos, professores e funcionários, promovendo uma cultura de respeito e igualdade que ajuda a prevenir a perpetuação do ciclo de violência.
